    ...
    <section className="max-w-screen-xl mx-auto md:mt-16 mb-20">
      ...
      <div className="grid grid-cols-6 gap-x-2">
        ...
        <form className="grid grid-cols-2 h-fit col-span-6 md:col-span-4 md:grid-cols-3 mx-auto gap-y-8 gap-x-5 p-5  bg-neutral-300 rounded-lg font-bold">
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="marka">
              Marka
            </label>
            <select
              id="marka"
          ...
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="yakit">
              Yakıt
            </label>
            <select
              id="yakit"
          ...
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="govde">
              Gövde
            </label>
            <select
              id="govde"
          ...
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="vites">
              Vites
            </label>
            <select
              id="vites"
          ...
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="renk">
              Renk
            </label>
            <select
              id="renk"
          ...
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="motor">
              Motor
            </label>
            <input
              type="text"
          ...
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="fiyat">
              Fiyat
            </label>
            <input
              type="text"
          ...
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="resim1">
              Resim 1
            </label>
            <input
              type="text"
          ...
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="resim2">
              Resim 2
            </label>
            <input
              type="text"
          ...
          <div className="">
            <label className="block mb-2 font-semibold" htmlFor="resim3">
              Resim 3
            </label>
            <input
              type="text"
          ...
          <div className="md:col-span-2 ">
            <label className="block mb-2 font-semibold" htmlFor="açiklama">
              Açıklama
            </label>
            <textarea
              type="text"
