    ...
    return (
        <section className="max-w-screen-2xl mx-auto relative h-full">
            ...
            <div className="absolute md:top-40 top-5 md:left-10 left-5 text-white font-bold z-10">
                <h1 className="md:text-5xl text-md font-serif md:mb-10">Buradan Devam Edemezsiniz!</h1>
                <p className="md:text-lg text-xs  text-neutral-300 md:mb-16 mb-8 w-6/12">Aranan sayfa maalesef bulunamadı. Bunun nedeni, hatalı veya eski bir URL çağırmış olmanız olabilir. </p>
                <Link href="/" className="bg-blue-600 hover:bg-blue-700 md:px-10 px-5 py-1">
                    Anasayfa
                </Link>
            </div>
